    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="container-fluid">
          <form action="/leave/authorize/add" method="POST" class="needs-validation" novalidate>
            <div class="row mb-2">
              <label class="col-xl-4 col-md-4 col-form-label text-xl-end">ประเภท</label>
              <div class="col-xl-6 col-md-6">
                <select class="form-select type" name="type_id" data-placeholder="-- เลือก --" required>
            ...
            <div class="row mb-2">
              <label class="col-xl-4 col-md-4 col-form-label text-xl-end">รายชื่อ</label>
              <div class="col-xl-6 col-md-6">
                <select class="form-select user" name="user_id" data-placeholder="-- เลือก --" required>
                  <option value="">-- เลือก --</option>
                </select>
                <div class="invalid-feedback">
                  กรุณาเลือกช่องนี้.
...
$(document).on('click', '.btn_delete', function(e) {
  ...
  Swal.fire({
    ...
    if (result.value) {
      window.location.href = "/leave/authorize/delete/" + auth;
    } else {
      return false;
    }
  })
