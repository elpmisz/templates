    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="container-fluid">
          <form action="/helpdesk/authorize/add" method="POST" class="needs-validation" novalidate>
            <div class="row mb-2">
...
<script>
  ...
  $(document).on('click', '.btn_delete', function(e) {
    ...
    Swal.fire({
      ...
      if (result.value) {
        window.location.href = "/helpdesk/authorize/delete/" + auth;
      } else {
        return false;
      }
    })
