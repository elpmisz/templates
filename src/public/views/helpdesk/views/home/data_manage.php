...
$sql = "SELECT A.id AS request_id, A.status as request_status,A.*,B.name as service_name,
...
foreach ($result as $row) {
  $status = "<a href='/helpdesk/edit/{$row['request_id']}' class='badge text-bg-{$row['status_color']} fw-lighter'>{$row['status_name']}</a>";
