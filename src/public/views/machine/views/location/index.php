    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="container-fluid">
          <form action="/machine/location/add" method="POST" class="needs-validation" novalidate>
            <div class="row mb-2">
...
<div class="modal fade form_view" data-bs-backdrop="static">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="container-fluid">
          <form action="/machine/location/update" method="POST" class="needs-validation" novalidate>
...
<script>
  ...
  $(document).on("click", ".btn_view", function() {
    ...
    let location = $(this).prop("id");
    if (location) {
      $.ajax({
        url: '/machine/location/view',
        method: 'POST',
        data: {
          location: location
        },
